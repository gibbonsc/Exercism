...
Describe "PangramTests" {
    ...
    # 26-letter pangram from one of my favorite childhood novels:
    # Hicks, Clifford B. Alvin's Secret Code. New York: Holt, Rinehart and Winston, 1963.
    It "Shoie's Cipher Key" {
        $got = Invoke-Panagram -Sentence "V.F.X.: Blitz, Jr., Ph.D., knows Guy Q. Mace"
